                                ...
                                <div class="col-md-3">
                                    <div class="form-group mb-0">
                                        <input type="number" class="form-control" id="minPriceFilter"
                                            placeholder="{{ __('Min Price') }}" value="{{ request('min_price') }}" step="0.01" min="0">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group mb-0">
                                        <input type="number" class="form-control" id="maxPriceFilter"
                                            placeholder="{{ __('Max Price') }}" value="{{ request('max_price') }}" step="0.01" min="0">
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-2">
...
@push('js')
    <script>
        ...
        // Category filter - immediate filter
        $('#categoryFilter').on('change', function() {
            performFilter();
        });

        // Price filters - with debounce
        $('#minPriceFilter, #maxPriceFilter').on('keyup', function() {
            clearTimeout(filterTimeout);
            filterTimeout = setTimeout(function() {
                performFilter();
            }, 500);
