            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form-material form-horizontal" action="{{ route('unit.store') }}"
                                method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" id="name" name="name"
                                            ...
                                            placeholder="{{ __('Enter unit name') }}" value="{{ old('name') }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea id="description" name="description"
                                            ...
                                            placeholder="{{ __('Write your unit description here...') }}" rows="8">{{ old('description') }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group mt-3 text-right">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save"></i> {{ __('Create Unit') }}
                                    </button>
                                </div>
                            </form>
                        </div>
